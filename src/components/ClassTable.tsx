...
/** Given a number or string value and a formatter function, returns a formatted value */
const valueFormatter = (value: string | number, formatter: ValueFormatter) => {
